...
//        return redirect()->route($url,$data)->with([$code ? 'success_message' : 'error_message' => $msg, 'url' => route($url)]);
...
if (!function_exists('check_auth')) {
     ...
     * 根据route name判断是否有权限
     */
    function check_auth($route_name){
        return in_array($route_name,session(LOGIN_USER)->auth_route_name);
    }
